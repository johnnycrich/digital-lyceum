package comps.scheduling.scheduleClasses
{
   import comps.scheduling.ScheduleViewer;
   import comps.scheduling.scheduleClasses.layout.AbstractEntryLayout;
   import comps.scheduling.scheduleClasses.layout.BackgroundLayout;
   import comps.scheduling.scheduleClasses.layout.BestFitLayout;
   import comps.scheduling.scheduleClasses.layout.HorizontalLinesLayout;
   import comps.scheduling.scheduleClasses.layout.IBackgroundLayout;
   ...
   import comps.scheduling.scheduleClasses.layout.VerticalLinesLayout;
   import comps.scheduling.scheduleClasses.renderers.IScheduleEntryRenderer;
   import comps.scheduling.scheduleClasses.viewers.BackgroundViewer;
   import comps.scheduling.scheduleClasses.viewers.EntryViewer;
   import comps.scheduling.scheduleClasses.viewers.HorizontalLinesViewer;
   import comps.scheduling.scheduleClasses.viewers.IHorizontalLinesViewer;
   import comps.scheduling.scheduleClasses.viewers.IVerticalLinesViewer;
   ...
   {      
      ...
      public function initialize() : void
      {
		...
		public function initializeRuntimeViewLayers() : void
		{
			...
			horizontalLinesLayoutImpl.addEventListener( LayoutUpdateEvent.UPDATE, horizontalLinesViewerImpl.update );
