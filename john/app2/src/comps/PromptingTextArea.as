...
public class PromptingTextArea extends TextArea
{
	...
	// Flag to prevent us from re-inserting the prompt if the text is cleared while the component still has focus
	private var _currentlyFocused:Boolean = false;
	
		
	// Constructor
	public function PromptingTextArea():void
	{
		_textEmpty = true;
	...
	private var _promptFormat:String = '<font color="#262525"><i>[prompt]</i></font>';
